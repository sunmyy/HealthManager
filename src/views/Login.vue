<template>
    <el-container class="container">
        <el-header class="header">
            ...
            <img class="logo" src="../assets/img/login/pe_loginlogo.png">
        ...
        <el-footer>
            <el-row class="footer">
                <el-col :span="12" :offset="6">
                    <div id="footer">
                        <div class="footerNav">
                            <a rel="nofollow" href="http://www.xiyou.edu.cn/">关于我们</a> | <a rel="nofollow"
                                                                                            href="http://www.xiyou.edu.cn/">服务条款</a>
                            | <a rel="nofollow" href="http://www.xiyou.edu.cn/">免责声明</a> | <a rel="nofollow"
                                                                                              href="http://www.xiyou.edu.cn/">网站地图</a>
                            | <a rel="nofollow" href="http://www.xiyou.edu.cn/">联系我们</a>
                        </div>
                        <div class="copyRight">
                            Copyright ?2021-2021xupt 版权所有
                        </div>
                    </div>
                </el-col>
            </el-row>
